...
C {vsource.sym} -40 250 0 1 {name=V_WWL value=0 savecurrent=false}
C {gnd.sym} -40 320 0 1 {name=l3 lab=0}
C {vsource.sym} -40 20 0 1 {name=V_WL value=3.3 savecurrent=true}
...
C {vsource.sym} 760 220 0 0 {name=V_BLB value=0 savecurrent=false}
