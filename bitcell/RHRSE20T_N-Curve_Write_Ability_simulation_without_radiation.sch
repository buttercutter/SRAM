...
N 540 -140 540 -100 {lab=0}
N 540 -250 540 -200 {lab=x1.Q}
...
C {vsource.sym} -40 250 0 1 {name=V_WWL value=3.3 savecurrent=false}
C {gnd.sym} -40 320 0 1 {name=l3 lab=0}
C {vsource.sym} -40 20 0 1 {name=V_WL value=0 savecurrent=true}
...
C {vsource.sym} 760 220 0 0 {name=V_BLB value=3.3 savecurrent=false}
C {gnd.sym} 760 290 0 1 {name=l5 lab=0}
C {vsource.sym} 950 80 0 0 {name=V_BL value=0 savecurrent=false}
