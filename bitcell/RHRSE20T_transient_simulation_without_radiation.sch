...
N 530 -70 530 -30 {lab=0}
N 530 -180 530 -130 {lab=SRAM_VDD}
...
C {vsource.sym} 530 -100 0 0 {name=V1 value=3.3 savecurrent=false}
C {gnd.sym} 530 -30 0 0 {name=l2 lab=0}
C {lab_pin.sym} 530 -180 0 0 {name=p1 sig_type=std_logic lab=SRAM_VDD}
...
C {vsource.sym} 760 220 0 0 {name=V_BLB value="pulse 0 3.3 20n 100p 100p 50n 100n" savecurrent=false}
C {gnd.sym} 760 290 0 1 {name=l5 lab=0}
C {vsource.sym} 950 80 0 0 {name=V_BL value="pulse 0 3.3 20n 100p 100p 50n 100n" savecurrent=false}
